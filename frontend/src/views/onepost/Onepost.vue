<template>
    <main class="row justify-content-center no-gutters">
        ...
        <section class="card col-md-8 ml-4 mr-4 bg-light bloc-onepost">            
            ...
            <div class="d-flex justify-content-between">
                <button 
                    type="button" 
                    class="btn btn-info btn-md mb-3 mt-3 ml-3 edit__btn" 
                ...
                <button 
                    type="button" 
                    class="btn btn-danger btn-md mb-3 mt-3 mr-3 delete__btn" 
                    v-if="user.isadmin == true || onePost.userId == user.userId"
                    data-toggle="collapse" 
            ...
            <section class="collapse mb-2 edit__card" id="editMsgCollapse">
                <div class="card bg-light border-0">
                    <form method="PUT" id="formValid" ref="formValid" class="needs-validation text-left border-0">
                        <div class="mr-2 ml-2 mt-3 text-dark">                    
        ...
        updatePost() {
            ...
            axios
                ...
                .then(() => {
                    ...
                    setTimeout(()=>{this.successMsg = !this.successMsg}, 2000),
