<template>
    <main class="row justify-content-center no-gutters">
        <div class="col-md-6">
            ...
            <section class="card bg-light register__box mb-5 ml-2 mr-2">            
                <h2 class="text-dark text-center mt-3 font-weight-light">Créer un compte</h2>                            
                <form method="POST" id="formValid" ref="formValid" class="needs-validation text-left">
                    <div class="col-md-8 mr-auto ml-auto mt-3 text-dark">                    
                        ...
                        <div class="text-center">                        
                            <button class="btn btn-info btn-md mb-4 " type="submit" @click.prevent="validateForm()">Valider mes informations</button>                        
                        </div>
                        <div class="text-center">
                            <button class="btn btn-success btn-md mb-4 " type="submit" v-if="showSubmitBtn" @click.prevent="submitForm()">Créer mon compte</button>                        
                        </div>
                    </div>    
                </form>
            </section>
